...
@Component({
  ...
  styles: [
    '.input { width: 100%; height: 40px; padding-left: 2.5rem; border: 2px solid transparent; border-radius: 8px; background-color: #f3f3f4; transition: .3s ease; }',
    ...
    'h1 { font-size: 50px; }',
    'button { margin: 15px 5px 0px 5px }',
    '@media only screen and (max-width: 768px) {.px-5 { padding: 5px 5px 5px 5px }}',
  ],
})
